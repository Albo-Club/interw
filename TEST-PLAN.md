...
✅ **Expected**: neutral confirmation screen, **identical** to the next case (3.2). A "Reset your interw password" email arrives in the inbox.
...
- Subject: "Approve email change on interw".
