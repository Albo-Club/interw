...
| ID8c | **Removal keeps the credit** | Have admin B set a decision on a candidate and send an invitation, then remove B | The decision line, B's entries in the decision history and the pending invitation still name B, greyed and italic with "(removed)" / "(retiré)". Delete B's account: all three read "Former member" / "Ancien membre". No address appears that was not shown before |
