...
| B12 | Candidate bundle budget | `pnpm build:app && pnpm bundle:budget` | Prints the gzip size of what `/s/$token/interview` loads and its largest chunks; exit 0 at or under 282 KiB (280.3 KiB when last raised) |
