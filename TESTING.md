...
| ID8 | **Removal ends access** | Put member B on a role's team, have B create another role and a report share link, remove B, complete an interview on each, re-invite B as a plain member | B receives no "report ready" email while removed; B's share link now shows "This link was revoked" (h03); after re-invite B sees **neither** role: not the first (the team row went with the membership), nor the one B created (the creator's seat belongs to the membership it was created in) |
