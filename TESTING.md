...
| IB4 | Welcome screen | Open the link | Greeting, role, question count, "Up to N minutes" (IA2b), and a **What you'll need** block (camera and microphone, a quiet place, keep the page open). The only secondary link is **Your data**, in the footer. No app navigation anywhere on the page |
