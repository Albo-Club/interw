...
const statusIcons: Record<ToolPart['state'], ReactNode> = {
  'approval-requested': <ClockIcon className="size-4 text-warning-strong" />,
  'approval-responded': <CheckCircleIcon className="size-4 text-info-strong" />,
  'input-available': <ClockIcon className="size-4 animate-pulse" />,
  'input-streaming': <CircleIcon className="size-4" />,
  'output-available': <CheckCircleIcon className="size-4 text-success-strong" />,
  'output-denied': <XCircleIcon className="size-4 text-warning-strong" />,
  'output-error': <XCircleIcon className="size-4 text-destructive-strong" />,
}
